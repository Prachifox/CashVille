...
<html>
 ...
 <li>   <div class="user-view">
    <div class=" background grey darken-3"></div>
      <a href="#">
          <img src="images/person2.jpg" alt="" class="circle">
        </a>
 ...
 <div class="row grey lighten-4">
      <div class="col s12 m6 offset-m3">
          ...
          <div class="card-image">
            ...
            <span class="card-title">Welcome Customer</span>
          </div>
        </div>
      </div>
      </div>
...
out.println("<div class='col s12 m4'><div class='card'> <div class='card-image'><img height='320' width='140' src="+p+" /></div><div class='card-content'><h5>Product Name:<br><h4>"
+i+"</h4><br>Price  :"+j+"<br>Quantity Available:"+k+"</h5></div> </div> </div>");
